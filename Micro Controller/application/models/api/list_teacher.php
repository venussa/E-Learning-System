 ...
 * list_teacher Class
 *
 * displays teacher data registered 
 ...
 */
	...
	class list_teacher extends load{
		...
		function __construct(){
			...
			$post["nidn%"] = clean_xss_string($this->get("q"));
			...
			$query = API_access("data_select?name=data_teacher".$page,true,$post);
