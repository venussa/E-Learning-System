<div class="main-container">
	...
	<div class="content" style="background: transparent;border: transparent;">
		...
		<div  class="right-box" style="width:65%;">
			...
			<form class="form-group body myform" method="POST" action="{homeURL}/activity/add_quiz?id={[id]}" redirect="{homeURL}/activity/new_quiz?id={[id]}&number=<?php echo $next_page?>" onSubmit="return submit_form(this)">
			...
			<div class="panel form-group">
				<div class="panel-heading" style="font-family: 'Segoe UI Bold';font-size:14px;">Number <?php echo $number?>
					...
					Jump Number : <select class="input" style="width: 60px;padding: 3px;" onchange="
						...
						move_page('{homeURL}/activity/new_quiz?id={[id]}&number='+$(this).val());
				...
				<div class="panel-body">
					...
					<span class="section" id="type-0" style="display: none;"><?php require_once(SERVER."/application/views/activity/form_multiple_choice.php")?>
						...
						<button class="btn-submit btn" type="button" style="margin-left:0px;display: none;"
						action="{homeURL}/activity/add_quiz?id={[id]}&action=insert" redirect="{homeURL}/activity/manage?id={activity_id}" form="false" onclick="return submit_form(this)"
						>Save & Finish</button>
