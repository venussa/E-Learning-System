	...
	<div class="content" style="background: transparent;border: transparent;">
		...
		<div class="panel">
			<div class="panel-body">
				...
				<a href="{homeURL}/teacher/detail?id={teacher_id}" <?php SPA_attribute()?> >
				...
				<p style="text-align: center;">
					<a href="{homeURL}/my_courses/detail?nidn={activity_id}" <?php SPA_attribute()?> >
					<button class="btn-default">Cancel</button>
					</a>
					<button class="btn" method="POST" action="{homeURL}/my_courses/attempt_quiz?id={[id]}" redirect="{homeURL}/my_courses/quiz?id={[id]}&page=1" form="false" onclick="return submit_form(this)">Attempt Quiz Now</button>
				</p>
			</div>
		</div>
