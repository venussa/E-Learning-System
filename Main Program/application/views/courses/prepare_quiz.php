	...
	<div class="content" style="background: transparent;border: transparent;">
		...
		<div class="panel">
			<div class="panel-body">
				...
				<p style="text-align: center;background: #eff28f;width: 98%;margin: auto;padding-top:10px;padding-bottom:10px;">
					<i style="color:#434343">The quiz hasn't started yet</i>
				</p>
