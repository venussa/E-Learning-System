<div class="main-container">
	...
	<form method="POST" action="{homeURL}/teacher/add_data" redirect="{homeURL}/teacher/" onSubmit="return submit_form(this)" enctype="multipart/form-data">
	<div class="left-box">
		...
		<div class="panel">
			...
			<table width="100%" style="margin-left:30px;" class="form-group">
				...
				<tr>
					...
					<td class="table-value">
						<input type="text" name="nidn" class="input" style="width:89%;" required>
					</td>
	...
	<div class="right-box">
		...
		<div class="panel">
			...
			<p style="font-size: 14px;margin-left: 10px;"><b>Role</b> : 
				<input type="checkbox" style="cursor: pointer;" value="1" name="level"> Manager
			</p>
		...
		<div class="panel">
			...
			<a href="{homeURL}/teacher/" <?php SPA_attribute()?>><button class="btn-default" type="button" style="width: 97%">Cancel</button></a>
		</div>
	</div>
