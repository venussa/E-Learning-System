<div class="main-container">
	<div class="navigator">
		...
		<span><a href="{homeURL}" <?php SPA_attribute()?> >Dashboard</a> / Teacher</span>
	</div>

	<div class="content">
		<div class="header">
		<form method="get" class="form-group" action="{homeURL}/teacher" onSubmit="return search_form(this)">	
			<?php if(userData()["level"] == 1) { ?>
			<span style="margin-left:10px;font-size: 13px;">
				<a href="{homeURL}/teacher/add" <?php echo SPA_attribute()?>><button class="btn" style="padding: 6px;" type="button">Add New</button></a>
			...
			<?php } ?>
				...
				<input type="text" class="input" name="q" style="width: 350px;padding: 5px;" placeholder="Ex : Teacher ID, Name, address, Contact Number" value="{urldecode[q]}">
		...
		<form method="post" class="form-group" action="{homeURL}/teacher/action" redirect="{documentURL}" onSubmit="return submit_form(this)" style="margin-top: 0px;">
		...
		<table class="list-table">
			<tr>
				...
				<td style="font-family:Segoe UI Bold;font-size:14px;" colspan="1">Contact</td>
				<td></td>
			</tr>
			{list_data}
		</table>
