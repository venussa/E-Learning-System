<div class="main-container">
	<div class="navigator">
		...
		<span>
			...
			<?php } else{ ?>
				...
				<a href="{homeURL}/student/detail?nidn={nidn}" <?php SPA_attribute()?> >{first_name} {last_name}</a> /
				Edit
			<?php } ?>
		</span>
	</div>
	...
	if((splice(1) !== "profile") and ($this->get("nim") !== userData()["nim"]))
		$url = "student/detail?nim={nim}";
	else
		$url = "profile";
	?>

	<form method="POST" action="{homeURL}/student/update_data" redirect="{homeURL}/student/detail?nim={nim}" onSubmit="return submit_form(this)" enctype="multipart/form-data">
	<div class="left-box">
		...
		<div class="panel">
			...
			<table width="100%" style="margin-left:30px;" class="form-group">
				...
				<tr>
					...
					<td class="table-value">
						<input type="text" name="nim" value="{nim}" class="input" style="width:89%;background: #f5f5f5;" readonly="" required>
					</td>
	...
	<div class="right-box">
		...
		<div class="panel">
			...
			else $url = "{homeURL}/student/detail?nidn={nidn}";
			?>
