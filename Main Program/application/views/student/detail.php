<div class="main-container">
	...
	<div class="right-box">
		...
		<div class="panel">
			...
			<p style="font-size: 14px;margin-left: 10px;"><b>Faculty</b> : {faculty_name}</p>
			<p style="font-size: 14px;margin-left: 10px;"><b>Major</b> : {major_name} ({level})</p>
			<p style="font-size: 14px;margin-left: 10px;"><b>Class</b> : {class}</p>
		</div>
		...
		<div class="panel">
			...
			else $url = "{homeURL}/student/edit?nidn={nidn}";
			?>
