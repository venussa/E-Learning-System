...
<body>
    ...
    <div id="preload" style="width: 100%;position:fixed;height: 10000px;background: #fff;z-index: 999;text-align: center;">
        
        <img src="ovalo.svg" style="margin-top: 50px;"><p style="font-size: 20px;margin-top: -50px;">Please Wait</p>
    </div>
