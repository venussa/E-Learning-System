...
if(!isset($_SESSION['username']) or empty($_SESSION['username'])){
    echo "<p style='font-size:30px;text-align:center;font-family:Arial;font-weight:600;margin-top:150px;'>Forbidden Access</p>";
    exit;
}
...
$dir_name = $dir_name[count($dir_name)-6];
...
$config = array(
    ...
    */
    ...
    |
    */
    'upload_dir' => '/sources/repository/'.$_SESSION['username']."/upload/",
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'current_path' => '../../../../sources/repository/'.$_SESSION['username']."/upload/",
